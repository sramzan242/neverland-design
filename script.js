...
function gsapScrollTriggerInitialize() {
    ...
    const locoScroll = new LocomotiveScroll({
      el: document.querySelector("#main canvas"),
      smooth: true
    });
    ...
    ScrollTrigger.scrollerProxy("#main canvas", {
      scrollTop(value) {
      ...
      pinType: document.querySelector("#main canvas").style.transform ? "transform" : "fixed"
    });
